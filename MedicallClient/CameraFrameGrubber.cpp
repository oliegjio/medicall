...
CameraFrameGrabber::CameraFrameGrabber(QWidget *widget, QObject *parent) :
...
void CameraFrameGrabber::updateVideoRect()
{
...
void CameraFrameGrabber::paint(QPainter* painter)
{
