...
QT_MOC_LITERAL(1, 12, 10), // "switchView"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "index"
QT_MOC_LITERAL(4, 30, 18) // "loginButtonClicked"

    },
    "WelcomeView\0switchView\0\0index\0"
    "loginButtonClicked"
};
...
void WelcomeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (WelcomeView::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WelcomeView::switchView)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WelcomeView::switchView(int _t1)
{
