...
QT_MOC_LITERAL(3, 31, 24), // "switchToRegistrationView"
QT_MOC_LITERAL(4, 56, 18), // "loginButtonClicked"
QT_MOC_LITERAL(5, 75, 21) // "registerButtonClicked"

    },
    "WelcomeView\0switchToLoginView\0\0"
    "switchToRegistrationView\0loginButtonClicked\0"
...
void WelcomeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->switchToRegistrationView(); break;
        case 2: _t->loginButtonClicked(); break;
        case 3: _t->registerButtonClicked(); break;
        default: ;
        }
        ...
        {
            typedef void (WelcomeView::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WelcomeView::switchToRegistrationView)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void WelcomeView::switchToRegistrationView()
{
