...
QT_MOC_LITERAL(1, 10, 10), // "switchView"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 5), // "index"
QT_MOC_LITERAL(4, 28, 12), // "loginClicked"
QT_MOC_LITERAL(5, 41, 11) // "backClicked"

    },
    "LoginView\0switchView\0\0index\0loginClicked\0"
    "backClicked"
};
...
void LoginView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->switchView((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (LoginView::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginView::switchView)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginView::switchView(int _t1)
{
